 ...
 <div class="q-pa-md q-gutter-md">
	...
	clickable v-ripple>
	  ...
	  Reason
          ...
          <q-btn to="/edit" style="background:green; color:white" label="Edit" size="sm" @click="editUser(user.id)" />
          <q-btn style="background:orange; color:white" label="Complete" size="sm" @click="deleteUser(user.id)" />
          </div>
...
deleteUser(doc){
  if(confirm('Student is completed ?')){
    
db.collection('waiting_details').doc(doc).delete().then(function(){
  console.log("Gone");
