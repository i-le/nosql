...
mongoose.connect('mongodb://10.92.130.23:27017/blogger', { useNewUrlParser: true });
...
app.get('/blogs/edit-blogs/:_id', function(req, res) {
...
app.post('/blogs/add', [check('title').not().isEmpty().withMessage('Title is a required field.')], function(req, res){
...
app.put('/blogs/edit-blogs/:_id', [check('title').not().isEmpty().withMessage('Title is a required field.')], function(req, res){
...
{
const options = {returnNewDocument:true};
Blog.updateBlog(req.params._id, newUser, options, (err, blog) => {
		if(err){
		throw err;
		}
